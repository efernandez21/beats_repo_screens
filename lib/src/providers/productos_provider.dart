...
// Provider para la carga de la lista de productos en la app
class ProductosProvider extends ChangeNotifier{
  ...
  // Obtengo los productos, el valor no cambia
  List<ProductoModel> get productos => _productos;



  // Este metodo traeria la informacion si esposible de la api
  _cargarProductos() {
    // Creamos producto por producto
    ...
    // Agregacion a la lista de productos
